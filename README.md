...
Measured incremental footprint on a real ESP32 (Xtensa) build: **520 bytes** for three event types split across both storage policies below — see [Research/PROGRESS.md](Research/PROGRESS.md) for the current number and how it's measured.
